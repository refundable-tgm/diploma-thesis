...
\end{code}
\captionof{listing}[VueJS Beispiel]{Beispiel für \textit{VueJS} Webseite}~\\
\subsubsection{React}
...
\end{code}
\captionof{listing}[React-Webseite Beispiel]{Beispiel für \textit{React} Webseite}~\\
\newpage
...
\end{code}
\captionof{listing}[React-Komponente Beispiel]{Beispiel für eine \textit{React}-Komponente}
\newpage
...
\begin{table}
	\captionof{table}[Vergleich JavaScript-Frameworks]{Vergleich von \textit{\Gls{js}}-\Gls{framework}s}\label{tab:vergleich}
	\centering
...
\end{code}
\captionof{listing}[HTTP-Anfrage mittels Axios]{Umsetzung einer \textit{HTTP}-Anfrage mittels \textit{Axios}}~\\
...
\end{code}
\captionof{listing}[Axios Anfrage mit genauem Pfad]{Umsetzung einer \textit{Axios} Anfrage unter Verwendung eines genauen Pfades}~\\
