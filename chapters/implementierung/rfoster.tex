...
Wird ein Link eingegeben, welcher nicht ''/'' oder ''/viewer'' entspricht, so wird die PageNotFound Komponente geladen und dem Benutzer mitgeteilt, dass der eingegebene Link nicht funktioniert.
