...
\end{code}
\captionof{listing}{Laden der Neuigkeiten auf der Startseite}~\\
...
\end{code}
\captionof{listing}{Anfrage um Sitzung des Nutzers zu aktualisieren}~\\
...
\end{code}
\captionof{listing}{POST-Anfrage für den Login}~\\
...
\end{code}
\captionof{listing}{Gesamte Anfrage für das Abmelden}~\\
\newpage
