...
In besonderen Fällen, wie in Kapitel \hyperref[sec:antrag_viewer]{7.3.1.4} beschrieben, wird der Benutzer nicht auf die Hauptseite weitergeleitet, sondern auf den Antrag-Viewer oder auf die Antrag Ansicht.
\begin{code}{js}
...
Das JSON-Objekt wird, wie in Kapitel \hyperref[code_submit_data]{7.3.4.1} beschrieben, erstellt. Für eine Fortbildung gibt es nur wenige Änderungen.
...
Das JSON-Objekt wird, wie in Kapitel \hyperref[code_submit_data]{7.3.4.1} beschrieben, erstellt. Für einen Sonstigen Antrag gibt es nur wenige Änderungen.
...
Der Aufbau der Antrag Ansicht ähnelt dem aus dem Kapitel \hyperref[sec:antrag_ansicht]{7.3.5}.\\
...
Die Übersichtsseite für Administratoren ähnelt dem Aufbau aus dem Kapitel \hyperref[sec:antrag_uebersicht]{7.3.6}.\\
