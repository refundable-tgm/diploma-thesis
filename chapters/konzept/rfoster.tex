...
Die Schnittstelle zwischen Frontend und Backend wird mittels \textit{JavaScript}-Framework umgesetzt. Wie in Kapitel \autoref{sec:rfoster_fazit} beschrieben, wird hierfür \textit{VueJS} verwendet. \textit{VueJS} bietet viele passende Funktionen und Features, um  eine solche Webseite umzusetzen.
