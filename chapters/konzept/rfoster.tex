...
Die Schnittstelle zwischen Frontend und Backend wird mittels JavaScript-Framework umgesetzt. Wie in Kapitel \autoref{sec:rfoster_fazit} beschrieben, wird hierfür VueJS verwendet. VueJS bietet viele passende Funktionen und Features, um  eine solche Webseite umzusetzen.
