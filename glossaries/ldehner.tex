...
\newglossaryentry{cdn}{
	name={CDN},
	description={CDN oder auch Content Delivery Network. Darunter kann man sich eine Online Datenbank vorstellen, welche optionale Komponenten (wie vorgefertigte CSS Skripte)} beinhaltet, damit man sie nicht lokal am Server speichern muss
}
