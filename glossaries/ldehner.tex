...
\newacronym{cdn-acro}{CDN}{Content Delivery Framework}

\newacronym{html-acro}{HTML}{Hypertext Markup Language}

\newacronym{css-acro}{CSS}{Cascading Style Sheets}

\newacronym{js-acro}{JS}{Java Script}

\newacronym{sass-acro}{SASS}{Syntactically Awesome Style Sheets}

\newacronym{itp}{ITP}{Informationstechnische Projekte}

\newacronym{pmi}{PMI}{Project Management Institut}
